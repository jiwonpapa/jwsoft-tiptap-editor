...
> 2026-09-02 [RC2 테마·본문 서식 배포](theme-rc2-closeout.md)를 완료했습니다. 현재 `jw-editor` 명칭·도움말·Apache-2.0의 0.1.1 변경은 별도 검증 대상입니다. 초기 페이지 저장 누락 관찰은 원인 미확정으로 기록하며 RC2의 통과를 새 버전의 승인으로 재사용하지 않습니다.
