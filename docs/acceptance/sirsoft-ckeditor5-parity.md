...
2026-08-31에는 플러그인의 공개 상태 API 호출을 보완하고 실제 G7 엔진과 에디터 소스의 DOM 통합 회귀 5개를 확인했습니다. [본문 동기화 보완과 남은 검증](g7-state-sync-regression.md)에 기록하며, 인증된 실제 저장·재조회 및 배포 완료를 뜻하지 않습니다.
