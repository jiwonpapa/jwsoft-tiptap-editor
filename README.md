...
> 현재 상태: **MVP 4차 이미지 하위 시스템 구현 단계**입니다. 기본 편집 기능과 게시판 canonical 저장 경로에 이미지 업로드·관리·미사용 정리·외부 최적화 훅을 연결했습니다. 실제 G7 DB 설치·인증 화면·브라우저 IME·전체 화면 parity가 남아 있어 아직 운영 설치 대상은 아닙니다.
