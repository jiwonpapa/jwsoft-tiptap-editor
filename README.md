...
> 현재 checkout은 세로 MP4 비율 보완 후보 **0.1.1-rc.1** 검증 중입니다. 공개 릴리스와 `main`의 미출시 변경은 다를 수 있습니다. 과거 버전의 완료 수를 최신 승인으로 사용하지 않습니다. 소유자가 승인한 단계별 57/60/61/62 게이트로 동일 ZIP을 검증하며, 최종 통과와 실제 운영 배포는 별도 결과로 보고합니다.
